...
You can replicate this analysis yourself by entering the data into the [extrapolation calculator](/) and selecting the logarithmic model to see the fitted curve and projected values.
