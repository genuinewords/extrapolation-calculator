...
<figure>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 280" class="w-full max-w-2xl mx-auto my-6 rounded-lg shadow-md" role="img" aria-label="Logarithmic curve: rapid initial growth that decelerates and flattens as x increases">
  ...
  <figcaption>The logarithmic model y = a + b·ln(x) visualized. The curve rises steeply at small x values, then progressively flattens as x increases — the mathematical signature of diminishing returns. The marginal gain (slope) shrinks continuously: doubling x from 12 to 24 adds less to y than doubling from 3 to 6 did. This shape matches real-world saturation processes like learning curves and market adoption.</figcaption>
</figure>
...
<figure>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 280" class="w-full max-w-2xl mx-auto my-6 rounded-lg shadow-md" role="img" aria-label="Exponential vs logarithmic: accelerating curve versus decelerating curve, mirrored shapes">
    <rect width="600" height="280" fill="#f8f8fc"/>
    <g font-family="Inter, sans-serif" font-size="11" fill="#374151">
