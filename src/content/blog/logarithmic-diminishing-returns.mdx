...
This concept also connects closely to [interpolation vs extrapolation](/blog/interpolation-vs-extrapolation.mdx/) — interpolation estimates within your observed data range and is generally reliable, but extrapolation into the future always carries uncertainty. Logarithmic models at least anchor that uncertainty in a shape that reflects how saturation works.
...
Start by entering your data into the [extrapolation calculator](/), compare the logarithmic fit against linear and exponential alternatives, and let the [R² score](/blog/r-squared-confidence.mdx/) guide your model selection. Supplement the numbers with your understanding of the underlying process, and you will be well equipped to make reliable forecasts in any domain where progress slows but does not stop.
...
Plot your data. If the curve rises quickly at first and then flattens out, logarithmic is a good candidate. Compare R² scores between logarithmic and [linear extrapolation](/blog/linear-extrapolation.mdx/) — if logarithmic has a significantly higher R², the diminishing-returns pattern is real.
