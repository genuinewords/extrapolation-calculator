...
<figure>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 260" class="w-full max-w-2xl mx-auto my-6 rounded-lg shadow-md" role="img" aria-label="Linear versus polynomial extrapolation patterns: straight line vs curve">
    ...
    <g font-family="Inter, sans-serif" font-size="11" fill="#374151">
      <g transform="translate(30, 30)">
        ...
        <text x="130" y="18" text-anchor="middle" font-weight="600" fill="#0a0a0a">Linear Extrapolation</text>
        ...
        <text x="130" y="190" text-anchor="middle" font-size="9" fill="#64748b" font-style="italic">constant slope</text>
      </g>
      <g transform="translate(310, 30)">
        <rect x="0" y="0" width="260" height="200" fill="#fff" stroke="#e5e7eb" rx="4"/>
        <text x="130" y="18" text-anchor="middle" font-weight="600" fill="#0a0a0a">Polynomial Extrapolation</text>
        <line x1="30" y1="170" x2="240" y2="170" stroke="#9ca3af" stroke-width="1"/>
        <line x1="30" y1="30" x2="30" y2="170" stroke="#9ca3af" stroke-width="1"/>
        <line x1="150" y1="30" x2="150" y2="170" stroke="#94a3b8" stroke-dasharray="3 3"/>
        <text x="160" y="35" font-size="9" fill="#64748b">extrapolation →</text>
        ...
        <text x="130" y="190" text-anchor="middle" font-size="9" fill="#64748b" font-style="italic">curve, slope changes</text>
      </g>
    </g>
  </svg>
  <figcaption>Linear vs polynomial extrapolation side by side. Linear projection (left) extends a constant slope indefinitely — predictable and stable, but cannot capture acceleration or deceleration. Polynomial projection (right) curves to match the changing rate of change, capturing acceleration patterns a straight line misses — but with greater risk of instability if the curve overshoots beyond the data range.</figcaption>
</figure>
...
Choosing the right extrapolation methods comes down to matching the math to the shape of your data. For more on the conceptual foundations, see our post on [interpolation vs extrapolation](/blog/interpolation-vs-extrapolation/).
...
<summary>What is the difference between linear and polynomial extrapolation?</summary>
...
<details class="faq-item">
<summary>When should I use polynomial extrapolation?</summary>
...
<details class="faq-item">
<summary>Is polynomial extrapolation more accurate?</summary>
