...
Interpolation estimates unknown values within the range of known data points. Unlike [extrapolation calculator](https://www.extrapolationcalculator.com/) methods that project beyond observed data, interpolation is bounded — your estimate is always surrounded by real measurements on both sides.
...
For numerical predictions beyond your data range, the [extrapolation calculator](https://www.extrapolationcalculator.com/) provides five methods suited to different trend patterns.
