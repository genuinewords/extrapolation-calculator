...
<figure>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 280" class="w-full max-w-2xl mx-auto my-6 rounded-lg shadow-md" role="img" aria-label="R-squared interpretation scale from poor to good fit, visualized with example data patterns">
    <rect width="600" height="280" fill="#f8f8fc"/>
    <g font-family="Inter, sans-serif" font-size="11" fill="#374151">
      <text x="40" y="22" font-weight="600" fill="#0a0a0a">R² Interpretation Scale</text>
      ...
      <text x="118" y="60" text-anchor="middle" font-size="11" font-weight="700" fill="#dc2626">Poor (0.0–0.3)</text>
      <text x="300" y="60" text-anchor="middle" font-size="11" font-weight="700" fill="#d97706">Moderate (0.3–0.7)</text>
      <text x="482" y="60" text-anchor="middle" font-size="11" font-weight="700" fill="#059669">Good (0.7–1.0)</text>
...
<figure>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 280" class="w-full max-w-2xl mx-auto my-6 rounded-lg shadow-md" role="img" aria-label="Polynomial trap: a high-degree polynomial that fits data perfectly inside the range but diverges wildly outside">
    <rect width="600" height="280" fill="#f8f8fc"/>
    <g font-family="Inter, sans-serif" font-size="11" fill="#374151">
      <text x="40" y="22" font-weight="600" fill="#0a0a0a">The Polynomial Trap: R²=1.0, Prediction=Absurd</text>
      ...
      <text x="100" y="55" font-size="10" fill="#64748b">Training data</text>
      <text x="240" y="55" font-size="10" fill="#dc2626" font-weight="600">Extrapolation diverges!</text>
      ...
      <text x="100" y="200" font-size="9" fill="#64748b">R² = 1.00 (perfect!)</text>
      <text x="430" y="265" font-size="10" fill="#dc2626" font-weight="600">Prediction: -150 (nonsensical!)</text>
    </g>
  </svg>
  <figcaption>The polynomial trap visualized. Inside the data range (left of the dashed line), a high-degree polynomial wiggles through every training point and achieves a perfect R² = 1.00. But the moment you step beyond the observed range (right of the dashed line), the same polynomial diverges wildly — swinging from very high to very low values, producing predictions that are mathematically perfect inside but practically absurd outside. This is why R² alone is a poor guide for extrapolation.</figcaption>
</figure>
