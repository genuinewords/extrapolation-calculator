...
As discussed, a higher R² can result from overfitting rather than genuine explanatory power. A linear model with R² = 0.88 that reflects a real physical relationship is far more valuable for extrapolation than a degree-5 polynomial with R² = 1.00 that merely memorizes the training data.
