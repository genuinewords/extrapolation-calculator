...
These models are not "extrapolation" in the classical sense, but they serve the same purpose: predicting beyond the data you've already observed.
...
For categorical data forecasting, you'll typically need statistical software: Python (scikit-learn), R, or Excel add-ins that support logistic regression and classification. The methods that handle categorical outcomes are more complex than a simple curve fit.
